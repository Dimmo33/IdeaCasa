...
$slider_js_options = array(
	...
	'rtl'            => is_rtl(),
	'prevArrow'      => '<div class="wvg-slider-prev-arrow">
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.875 0.535645L4.28571 7.12493C4.23447 7.17303 4.19362 7.23112 4.1657 7.29561C4.13778 7.36011 4.12337 7.42965 4.12337 7.49993C4.12337 7.57021 4.13778 7.63975 4.1657 7.70425C4.19362 7.76874 4.23447 7.82683 4.28571 7.87493L10.875 14.4642" stroke="white" stroke-width="1.07143" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

    </div>',
	'nextArrow'      => '<div class="wvg-slider-next-arrow">
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.125 0.535645L10.7143 7.12493C10.7655 7.17303 10.8064 7.23112 10.8343 7.29561C10.8622 7.36011 10.8766 7.42965 10.8766 7.49993C10.8766 7.57021 10.8622 7.63975 10.8343 7.70425C10.8064 7.76874 10.7655 7.82683 10.7143 7.87493L4.125 14.4642" stroke="white" stroke-width="1.07143" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
</div>',
					...
					<div class="woo-variation-gallery-thumbnail-slider woo-variation-gallery-thumbnail-columns-<?php echo esc_attr( $columns ) ?>" data-slick='<?php echo wc_esc_json( wp_json_encode( $thumbnail_slider_js_options ) ); // WPCS: XSS ok. ?>'>
						...
						if ( $has_gallery_thumbnail ) {
							...
							foreach ( $attachment_ids as $key => $attachment_id ) :
                                echo $firstKey;
								echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', woo_variation_gallery()->get_frontend()->get_gallery_image_html( $product, $attachment_id, array( 'is_main_thumbnail' => true ) ), $attachment_id );
							endforeach;
						}
						?>
					</div>
